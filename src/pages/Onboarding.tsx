    ...
    try {
      ...
      if (err instanceof Error) {
        if (err.message.includes('conexion')) {
          errorMessage = 'Error de conexion. Verifica tu internet e intenta de nuevo.';
        } else if (err.message.includes('invalido')) {
      ...
      <div className="w-full max-w-lg">
        <div className="flex items-center justify-center mb-8 gap-2">
          {[1, 2, 3].map((s) => (
            <div
              key={s}
              className={`h-2 w-16 rounded-full transition-colors ${s <= step ? 'bg-blue-600' : 'bg-slate-200'}`}
            />
          ))}
        </div>
        ...
        {step === 1 && (
          <Card className="p-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-slate-900 mb-3">Bienvenido a Removin</h1>

            <p className="text-slate-600 mb-8">
              Para usar las funciones de IA necesitas conectar tu cuenta de Replicate. Es gratis y
              solo toma 2 minutos.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="text-center">
                ...
                <p className="text-xs text-slate-600">Procesamiento rapido</p>
              </div>
              <div className="text-center">
        ...
        {step === 2 && (
          <Card className="p-8">
            <div className="text-center mb-6">
              ...
              <h2 className="text-xl font-bold text-slate-900">Configura tu API Token</h2>
              <p className="text-sm text-slate-500 mt-1">Sigue estos pasos para obtener tu token</p>
            </div>
            ...
            <div className="bg-slate-50 rounded-xl p-5 mb-6">
              <ol className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-900">Crea una cuenta en Replicate</p>
                    <p className="text-xs text-slate-500">Es gratis, puedes usar tu cuenta de GitHub</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <span className="shrink-0 w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-medium">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-900">Ve a tu perfil → API Tokens</p>
                    <p className="text-xs text-slate-500">Crea un nuevo token o copia el existente</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <span className="shrink-0 w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-medium">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-900">Pega el token aqui abajo</p>
                    <p className="text-xs text-slate-500">Empieza con r8_ y tiene ~40 caracteres</p>
                  </div>
                </li>
              </ol>
            </div>
            ...
            <div className="space-y-2 mb-6">
              <label className="text-sm font-medium text-slate-700">Tu API Token</label>
            ...
            <p className="text-xs text-center text-slate-400 mt-4">
              ...
              Tu token se guarda cifrado y nunca se comparte
            </p>
          </Card>
        )}
        ...
        {step === 3 && (
          <Card className="p-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-slate-900 mb-3">Todo listo</h1>

            <p className="text-slate-600 mb-8">
              Tu cuenta esta configurada. Ya puedes usar todas las funciones de Removin.
            </p>

            <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-8">
              <h3 className="font-medium text-green-900 mb-2">Funciones disponibles:</h3>
              <ul className="text-sm text-green-700 space-y-1">
                <li>Remover fondos de imagenes</li>
                <li>Generar imagenes con IA</li>
                <li>Monitoreo automatico de carpetas</li>
